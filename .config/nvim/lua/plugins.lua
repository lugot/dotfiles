...
return require('packer').startup(function(use)
  ...
  -- use 'romgrk/nvim-treesitter-context' use something in statusline instead

  -- Syntax
  -- use 'moll/vim-node'
  use 'zinit-zsh/zplugin-vim-syntax'
  -- use 'editorconfig/editorconfig-vim'
  use 'chrisbra/csv.vim' -- read cvs file easily
  ...
  -- use 'tpope/vim-commentary' -- doesent work nicely with cpp
